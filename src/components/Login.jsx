            ...
            <div className="flex items-center justify-center mb-6">
                ...
                <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg '>
                    ...
                    <div className='flex flex-col text-gray-400 py-2'>
                        <label>Correo</label>
                        <input className = 'rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue focus:bg-gray-800 focus:outline-none' type="text" />
                    </div>
                    <div className='flex flex-col text-gray-400 py-2'>
                        <label>Contraseña</label>
                        <input className = 'rounded-lg bg-gray-700 mt-2 p-2 focus:border-blue focus:bg-gray-800 focus:outline-none'type="password" />
                    </div>
